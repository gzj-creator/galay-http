#ifndef GALAY_WS_DEBUG_LOG_H
#define GALAY_WS_DEBUG_LOG_H

#include "HttpLogger.h"

// WebSocket 调试日志宏 - 通过 ENABLE_DEBUG 宏控制是否编译
// 当 ENABLE_DEBUG 未定义时，这些宏在编译时会被完全移除，零性能开销
    ...
    #define WS_LOG_DEBUG(...) ((void)0)  // 编译时完全移除
