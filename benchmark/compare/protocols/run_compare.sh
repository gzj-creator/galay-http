...
GALAY_HTTP_BIN="$GALAY_BUILD_DIR/benchmark/b1_http"
GALAY_HTTPS_BIN="$GALAY_BUILD_DIR/benchmark/b14_https"
GALAY_WS_BIN="$GALAY_BUILD_DIR/benchmark/b5_ws"
GALAY_WSS_BIN="$GALAY_BUILD_DIR/benchmark/b7_wss"
GALAY_H2C_BIN="$GALAY_BUILD_DIR/benchmark/b3_h2c"
GALAY_H2_BIN="$GALAY_BUILD_DIR/benchmark/b12_h2"
